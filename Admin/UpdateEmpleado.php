...
if (isset($_POST['Actualizar'])) {
    ...
    $query = "UPDATE tb_empleados SET N_Usuario = '$Usuario', N_Password = '$Contra', N_Nombre = '$Nombre', N_ApellidoPa = '$Apellido1', N_ApellidoMa = '$Apellido2', ID_Genero = '$Genero', N_Telefono = '$Telefono', ID_Rol = '$Rol', N_Correo = '$Correo', ID_Estado = '$Estatus' WHERE N_Empleado = '$id'";
...
if (isset($_GET['id'])) {
    $Id = $_GET['id'];
    $Query = "SELECT * FROM tb_empleados WHERE N_Empleado = '$Id'";
    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <div class="card card-body">
                <form id="actualizarForm" action="UpdateEmpleado.php?id=<?php echo $_GET['id']; ?>" method="POST">
                <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="cargo" id="cargo" required>
                                        ...
                                        while ($row = mysqli_fetch_assoc($resultado_roles)) {
                                            $selected = ($row['NID_Rol'] == $Rol) ? 'selected' : '';
                                            echo "<option value='" . $row['NID_Rol'] . "' $selected>" . $row['N_Rol'] . "</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
