...
// extraigo los datos de los socios para facilitar la consultas
$consulta_empleados = "SELECT * FROM vw_empleados";
$resultado_empleados = mysqli_query($conexion,$consulta_empleados);
// Definir el número de registros por página
$registros_por_pagina = 10;
// Calcular el número total de páginas
$query_total_registros = "SELECT COUNT(*) as total_registros FROM vw_empleados";
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-md-auto">
                <div class="fixed-right">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalNuevoEmpleados" data-toggle="tooltip" data-placement="top" title="Agregar Nuevo empleado">
...
<!-- modal de insercion -->
<div class="modal fade" id="modalNuevoEmpleados" tabindex="-1" aria-labelledby="modalNuevoEmpleadosLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalNuevoEmpleadosLabel">Agregar Coach</h5>
            ...
            <div class="modal-body">
                ...
                <form action="CreateEmpleado.php" method="POST">
...
<div class="container p-4">
    ...
    <div class="row justify-content-center">
            <table id="miTabla" class="table table-sm table-striped table-hover table-bordered text-center">
                ...
                <tbody>
                    <?php
                    while ($filas = mysqli_fetch_assoc($resultado_empleados)) {
                        // Mostrar los datos de cada fila de la tabla
                        echo "<tr class='table-success'>";
                        echo "<td>{$filas['N_Empleado']}</td>";
                        echo "<td>{$filas['N_Usuario']}</td>";
                        echo "<td>{$filas['N_Rol']}</td>";
                        ...
                        echo "<td>";
                        echo "<a href='UpdateEmpleado.php?id={$filas['N_Empleado']}' class='btn btn-warning' data-toggle='tooltip' data-placement='top' title='Editar'><i class='fas fa-marker'></i></a>";
                        echo "<a href='#' class='btn btn-danger btnEliminar' data-toggle='tooltip' data-placement='top' title='Eliminar' data-id='{$filas['N_Empleado']}'><i class='fas fa-trash-alt'></i></a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                    ?>
...
<script>
    $(document).ready(function() {
        ...
        $('.btnEliminar').click(function() {
            ...
            $('#btnConfirmarEliminar').attr('href', 'DeleteEmpleado.php?id=' + idClase);
