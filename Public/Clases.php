...
$query_nombre_entrenador = "SELECT N_Nombre FROM vw_empleados WHERE N_Nombre = '$nombreUsuario'";
...
$query_total_registros = "SELECT COUNT(*) as total_registros FROM vw_clases WHERE Nombre_Entrenador = '$nombreEntrenador'";
...
$query_registros = "SELECT * FROM vw_clases WHERE Nombre_Entrenador = '$nombreEntrenador' LIMIT $inicio, $registros_por_pagina";
