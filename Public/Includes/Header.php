...
<body>
    <nav class="navbar navbar-expand-sm navbar-light bg-light demo">
        <a class="navbar-brand" href="Inicio.php" style="color:white;">
            <picture>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                <li class="nav-item active">
                    <a class="nav-link" href="Clases.php" style="color:white;">Mis Clases</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="Asistencia.php" style="color:white;">Asistencias</a>
                </li>
